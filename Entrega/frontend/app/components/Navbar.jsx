        ...
        <nav className="flex justify-between mt-3 mx-20 items-center mb-3">
            ...
            </div>
            {
                toggleCart ?
                    <div className='flex'>
                        <div>
                            <div className='fixed top-0 left-0 w-full h-full bg-black opacity-50 z-10' onClick={handleCart}></div>
                        </div>
                        <div className={`cart flex flex-col`}>
                            <div className='flex justify-end m-3'>
                                <button className='justify-end' onClick={handleCart}><CloseIcon /></button>
                            </div>
                            <div>
